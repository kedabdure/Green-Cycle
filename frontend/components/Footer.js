  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        <Box sx={{ display: "flex", justifyContent: { xs: "center", md: "center" }, alignItems: "center", py: 2 }}>
          <Typography variant="body2" sx={{ mb: "1rem", fontSize: { xs: "0.45rem", sm: "0.6rem", md: ".75rem" }, color: "#e1e2e2" }}>
            &copy; {getCurrentYear()} Green Cycle. All Rights Reserved.
            Designed by <Link href={'https://www.linkedin.com/in/philofix'} style={{ color: "#48cb66" }} >Mensur</Link> and Powered by <Link href={'http://t.me/kedabdure'} style={{ color: "#48cb66" }} >Abdurehim Kedir </Link>
          </Typography>
        </Box>
      </Container>
